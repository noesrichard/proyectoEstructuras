...
enum ENTRADA {
    ...
    CEDULA_NUEVA    (MENSAJES.CEDULA_NUEVA,new Cedula(Cedula.CEDULA_NUEVA)), 
    ...
    CEDULA_EXISTENTE(MENSAJES.CEDULA_EXISTENTE, new Cedula(Cedula.CEDULA_EXISTENTE)), 
    ...
    private enum MENSAJES {
        ...
        CEDULA_NUEVA    ("INGRESE LA CEDULA: ","CEDULA NO VALIDA!"),
