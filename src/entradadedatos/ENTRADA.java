...
enum ENTRADA {
    ...
    CEDULA_NUEVA    (MENSAJES.CEDULA_NUEVA,new Cedula()), 
    ...
    CEDULA_EXISTENTE(MENSAJES.CEDULA_EXISTENTE, REGEX.NUMEROS_ENTEROS.txt()), 
    ...
    private enum MENSAJES {
        ...
        CEDULA_NUEVA    ("INGRESE LA CEDULA: ","LA CEDULA NO ES VALIDA O YA EXISTE UN PARTICIPANTE CON LA MISMA CEDULA!"),
        ...
        CEDULA_EXISTENTE("INGRESE LA CEDULA DEL PARTICIPANTE: ","ESTA CEDULA NO PERTENECE A NINGUN PARTICIPANTE REGISTRADO!");
